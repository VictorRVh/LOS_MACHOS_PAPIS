...
import useExportAsistencia from '../../../composables/sesiones/useExportAsistenciaAlumnos';  // Importa el composable


const { exportarAlumnosAsistencia } = useExportAsistencia();  // Obtén la función
...
const props = defineProps({
  ...
  llamarAsistencia: { type: Boolean, default: false },
        ...
        <div class="w-[90vw] max-w-screen-xl h-[90vh] bg-gray-100 dark:bg-gray-900 rounded-lg shadow-2xl flex flex-col"
          ...
          <footer v-if="!isLoadingData && alumnos.length > 0"
            ...
            <div class="flex items-center justify-between gap-4">
              ...
              <div class="flex gap-3 items-center" v-if="!llamarAsistencia">
