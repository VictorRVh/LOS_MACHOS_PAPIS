...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('estudiante', function (Blueprint $table) {
            ...
            $table->string('anio_egreso', 10)->nullable();
            $table->string('lengua_materna', 50)->nullable();


            $table->string('trabaja', 10)->nullable();
            $table->string('detalle_trabajo', 150)->nullable();

            $table->string('carga_familiar', 10)->nullable(); 
            $table->string('detalle_carga_familiar', 100)->nullable(); 
            ...
            $table->string('tipo_discapacidad', 150)->nullable();

            $table->string('celular_referencia', 9)->nullable();
            $table->string('parentesco_referencia', 50)->nullable();
