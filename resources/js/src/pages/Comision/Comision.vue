      ...
      >
        <div class="flex flex-col gap-1.5">
          <div class="flex flex-col gap-1">
            ...
            <h2 class="text-[1.2rem] font-semibold tracking-tight text-cetpro dark:text-cetpro-light">Comisión</h2>
          </div>
      ...
      <div class="flex flex-col gap-4 lg:flex-row">
        <section class="w-full border border-slate-200 bg-white p-3 shadow-sm transition-colors duration-300 dark:border-slate-700 dark:bg-slate-900 lg:w-1/3">
          <div class="mb-3">
            ...
            <h3 class="mt-1 text-[15px] font-medium text-slate-900 dark:text-slate-100">Agregar comisión</h3>
          </div>
        ...
        <section class="w-full border border-slate-200 bg-white p-3 shadow-sm transition-colors duration-300 dark:border-slate-700 dark:bg-slate-900 lg:w-2/3">
          <div class="mb-3">
            ...
            <h3 class="mt-1 text-[15px] font-medium text-slate-900 dark:text-slate-100">Lista de comisiones</h3>
          </div>
