...
<template>
    <div class="p-2 bg-gray-100 dark:bg-gray-900/50 font-inter">
        <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-4">Nueva Matrícula de Estudiante</h2>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-2 min-h-[400px]">
