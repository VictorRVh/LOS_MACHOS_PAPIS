...
const irARegistrar = () => {
    router.push({ name: 'matricula.registrar' });
}
</script>
    ...
    <AuthorizationFallback :permissions="['todo-acceso-permisos']">
        <div class="w-full space-y-2 py-2 px-3">
            <div class="flex justify-between items-center m-2">
                <h2 class="text-cetpro dark:text-cetpro-light font-bold text-2xl">Gestión de Matrícula</h2>
                <Button title="Registrar y Matricular Estudiante" @click="irARegistrar" />
            </div>

            <h3 class="text-lg font-semibold text-gray-700 dark:text-gray-300 px-2 mt-4">Grupos Disponibles</h3>
            <Table>
                <THead>
                ...
                <TBody>
                    <Tr v-for="grupo in gruposSimulados" :key="grupo.id">
