...
<template>
  <v-select
    ...
    class="base-v-select w-full text-sm"
  >
    <template #no-options>
...
:deep(.base-v-select .vs__dropdown-menu) {
  @apply mt-1 max-h-[180px] overflow-y-auto rounded-sm border border-slate-200 bg-white py-1 text-sm text-slate-800 shadow-sm;
}
